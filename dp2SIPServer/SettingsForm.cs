...
namespace dp2SIPServer
{
    public partial class SettingsForm : Form
    {
        ...
        public string EncodingName
        {
            get
            {
                return this.comboBox_encodingName.Text;
            }

            set
            {
                this.comboBox_encodingName.Text = value;
            }
        }
        ...
        public string DateFormat
        {
            get
            {
                return this.comboBox_dateFormat.Text;
            }

            set
            {
                this.comboBox_dateFormat.Text = value;
            }
        }
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            this.EncodingName = Properties.Settings.Default.EncodingName;
            this.DateFormat = Properties.Settings.Default.DateFormat;

            string strTerminator = Properties.Settings.Default.Terminator;
            if (strTerminator == "CR" || strTerminator == "LF")
                this.Terminator = strTerminator;
            else
                MessageBox.Show("【命令结束符】需要是回车(CR)或换行(LF)，请重新设置");
        }
        ...
        private void button_ok_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.EncodingName = this.EncodingName;
            Properties.Settings.Default.Terminator = this.Terminator;
            Properties.Settings.Default.DateFormat = this.DateFormat;
